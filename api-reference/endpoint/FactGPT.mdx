...
You can specify the language in the instruction to generate content in that language. We support all languages but better quality in following: 1. English 2. French 3. Italian 4. Dutch 5. Portuguese 6. German 7. Polish 8. Spanish
...
<ParamField body="topic" type="string">
  This field is used to input the text as an instructional prompt for generating
  content.
</ParamField>
...
<ParamField body="url_list" type="string" when="mode=url">
  This field is used to input the array of the URLs you want to provide as a
  reference, while generating the content.
</ParamField>

<ParamField body="fileid" type="string" when="mode=file">
...
<ResponseField name="citations" type="string">
  This array provides the source or the links of the sources considered while
  generating content.
</ResponseField>
